...
class ShocksInspection extends StatefulWidget {
  final String id;
  final String username;
  const ShocksInspection({super.key, required this.id, required this.username});

  @override
  State<ShocksInspection> createState() => _ShocksInspectionState();
}

class _ShocksInspectionState extends State<ShocksInspection> {
  ...
  final List<String> checkSleeperShckAbsrb = [
    S.current.check_SleeperShockAbsorber,
  ];

  final List<String> checkShckAbsrb = [
    S.current.check_shock_absorber_scr,
  ];
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            S.current.checklist_sleeper_shock_absorber,
                            style: TextStyle(
                              fontSize: 18,
                          ...
                          ...checkSleeperShckAbsrb.map((label) {
                            return CheckboxListTile(
                              title: Text(label),
                              value: data.getShocksGlobalCheck(label),
                              onChanged: (v) =>
                                  data.setShocksGlobalCheck(label, v!),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            S.current.checklist_Shock_Absorber,
                            style: TextStyle(
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                            ),
                          ...
                          onPressed: () {
                            ...
                            if (idx < wheels.length - 1) {
                              ...
                              Navigator.pushReplacement(
                                context,
                                CupertinoPageRoute(
                                  builder: (context) => AirbagsInspection(
                                      id: widget.id, username: widget.username),
                                ),
                              );
                            }
