...
class AirbagsInspection extends StatefulWidget {
  final String id;
  final String username;
  const AirbagsInspection(
      {super.key, required this.id, required this.username});

  @override
  State<AirbagsInspection> createState() => _AirbagsInspectionState();
}

class _AirbagsInspectionState extends State<AirbagsInspection> {
  ...
  final List<String> checkSleeperAirbag = [
    S.current.check_sleeper_airbag,
  ];

  final List<String> checkAirbag = [
    S.current.check_airbag,
  ];
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            S.current.sleeper_airbag_check,
                            style: TextStyle(
                              fontSize: 18,
                          ...
                          ...checkSleeperAirbag.map((label) {
                            return CheckboxListTile(
                              title: Text(label),
                              value: data.getAirbagGlobalCheck(label),
                              onChanged: (v) =>
                                  data.setAirbagGlobalCheck(label, v!),
