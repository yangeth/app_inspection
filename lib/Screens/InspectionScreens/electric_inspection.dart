...
import 'package:app_inspection/Screens/InspectionScreens/safety_inspection.dart';
...
class ElectricInspection extends StatefulWidget {
  final String id;
  final String username;
  const ElectricInspection(
      {super.key, required this.id, required this.username});

  @override
  State<ElectricInspection> createState() => _ElectricInspectionState();
}

class _ElectricInspectionState extends State<ElectricInspection> {
  final List<String> checklistElectric = [
    S.current.check_alternator,
    S.current.check_starter,
    S.current.check_batery,
  ];
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            S.current.title_ins_electric_checklist,
                            style: TextStyle(
                              fontSize: 18,
                          ...
                          ...checklistElectric.map((label) {
                            return CheckboxListTile(
                              title: Text(label),
                              value: data.getElectricGlobalCheck(label),
                              onChanged: (v) =>
                                  data.setElectricGlobalCheck(label, v!),
