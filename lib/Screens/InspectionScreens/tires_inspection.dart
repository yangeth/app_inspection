...
class TiresInspection extends StatefulWidget {
  final String id;
  final String username;
  const TiresInspection({super.key, required this.id, required this.username});

  @override
  State<TiresInspection> createState() => _TiresInspectionState();
}

class _TiresInspectionState extends State<TiresInspection> {
  ...
  final List<String> checkTires = [
    S.current.thread_tires,
    S.current.tires_tires,
    S.current.lug_tires
  ];
                          ...
                          onPressed: () {
                            ...
                            if (idx < wheels.length - 1) {
                              ...
                              Navigator.pushReplacement(
                                context,
                                CupertinoPageRoute(
                                  builder: (context) => ExhaustInspection(
                                      id: widget.id, username: widget.username),
                                ),
                              );
                            }
