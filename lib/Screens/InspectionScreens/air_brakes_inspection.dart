...
class AirBrakesInspection extends StatefulWidget {
  final String id;
  final String username;
  const AirBrakesInspection(
      {super.key, required this.id, required this.username});

  @override
  State<AirBrakesInspection> createState() => _AirBrakesInspectionState();
}

class _AirBrakesInspectionState extends State<AirBrakesInspection> {
  final List<String> checklistAirBrakes = [
    S.current.check_low_air_wrn,
    S.current.check_air_pression_bp,
    S.current.check_tractor_prot_v,
  ];
  int _paginaActual = 2;
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            S.current.title_ins_air_brakes_checklist,
                            style: TextStyle(
                              fontSize: 18,
                          ...
                          ...checklistAirBrakes.map((label) {
                            return CheckboxListTile(
                              title: Text(label),
                              value: data.getAirBGlobalCheck(label),
                              onChanged: (v) =>
                                  data.setAirBGlobalCheck(label, v!),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.pushReplacement(
                              context,
                              CupertinoPageRoute(
                                builder: (context) => TiresInspection(
                                    id: widget.id, username: widget.username),
                              ),
                            );
                          },
